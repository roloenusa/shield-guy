...
## Live Demo
http://phoenixshield_guy.herokuapp.com
...
defmodule ShieldGuy.UserSocket do
  use Phoenix.Socket

  channel "rooms:*", ShieldGuy.RoomChannel
...
#### Channel
```elixir
defmodule ShieldGuy.RoomChannel do
  use Phoenix.Channel
  require Logger
